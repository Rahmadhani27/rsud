                    ...
                    <div class="text-center">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td>Jenis Pasien</td> <td><?= $data['peminjam'] ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Masuk</td> <td><?= $data['tgl_pinjam'] ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Keluar</td> <td><?= $data['tgl_kembali'] ?></td>
                                </tr>
								<tr>
                                    <td>Lama Dirawat</td> <td><?= $data['lama_pinjam'] ?> hari</td>
                                </tr>
