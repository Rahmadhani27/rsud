            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Nama Pasien</th><th>Ruang Pasien</th><th width="14%"><center>Lahir<br> (Tanggal-Bulan-Tahun)</center></th><th width="15%">OrangTua</th><th width="10%">Tgl. Masuk</th><th>Perawat</th><th>Dokter</th><th>CETAK</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=arsip&actions=edit&uid=<?= $data['id'] ?>" class="btn btn-warning btn-xs"><span class="fa fa-edit"></span>
                                    </a>
